...
const OnboardingScreen = ({
    ...
    const setHasSeenOnboard = useSetHasSeenOnboarding();

    const screens = [
        {
            title: "Monitor Performance",
            description:
                "Track account growth and asset performance with clear, updated insights. Stay informed and confident in your financial journey.",
            image: require("../assets/onboarding1.png"),
        },
        {
            title: "Personalised Experience",
            description:
                "Customise your dashboard to align with your financial goals. WealthVault is designed for flexibility and speed.",
            image: require("../assets/onboarding2.png"),
        },
        {
            title: "Stay Connected",
            description:
                "Stay in sync with timely alerts on portfolio changes and real-time updates. Connect instantly with your advisor to keep your financial plan on track.",
    ...
    paddingHorizontal: 15, */}
        ...
        <View className="w-full p-4 ">
          <Text
            // style={styles.title}
           className="mx-5 font-bold text-xl py-4"
          >
